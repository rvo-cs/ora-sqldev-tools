...
define it_support_user = "C##IT_SUPPORT$OWNER"
 ...
 */
grant inherit any privileges to &&it_support_user container=all;
...
/*
    ...
    grant inherit privileges on user sys to &&it_support_user container=all;
        ^                             ^
        |                             |
...
grant select on sys.v_$latch    to &&it_support_user container=all;
grant select on sys.v_$sesstat  to &&it_support_user container=all;
grant select on sys.v_$statname to &&it_support_user container=all;
