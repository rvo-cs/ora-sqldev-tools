alias nulldefaults group=rvo-cs sql_compiler_trace=q'<
/*
...
alias desc sql_compiler_trace : **VERY VERBOSE** use sql_optimizer_trace instead

alias group=rvo-cs sql_compiler_trace_off=q'<set echo on
alter session set events = 'trace[rdbms.SQL_Compiler.*] off';
set echo off
>';

alias desc sql_compiler_trace_off : use sql_optimizer_trace_off instead
