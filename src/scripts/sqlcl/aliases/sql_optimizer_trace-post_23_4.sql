alias -silent -nulldefaults -group rvo-cs -desc "sql_optimizer_trace : turns tracing in the SQL optimizer on/off for this session" sql_optimizer_trace=q'
/*
...
alias -silent -group rvo-cs -desc "sql_optimizer_trace_off : turns off tracing in the SQL optimizer for this session" sql_optimizer_trace_off=q'
set echo on
