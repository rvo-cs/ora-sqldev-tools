alias -silent -nulldefaults -group rvo-cs -desc "sql_trace : turns SQL tracing on/off in the session" sql_trace=q'
/*
...
alias -silent -group rvo-cs -desc "sql_trace_off : turns off SQL tracing in the session" sql_trace_off=q'
set echo on
